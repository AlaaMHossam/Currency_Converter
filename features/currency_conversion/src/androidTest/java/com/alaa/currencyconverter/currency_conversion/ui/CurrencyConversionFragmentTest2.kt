...
@HiltAndroidTest
class CurrencyConversionFragmentTest2 {
    ...
    //CurrencyConverterViewModel(mockGetSymbolsCase, mockGetRatesCase)
    ...
    fun loading_view_state() {
        ...
        every { mockViewModel.fromAmount.value } returns ""
        every { mockViewModel.toAmount.value } returns ""
    ...
    fun from_list_has_data() {
        ...
        launchFragmentInHiltContainer<CurrencyConversionFragment> {
            ...
            updateSymbolsUI(DataState.Success(symbols()))
        }
