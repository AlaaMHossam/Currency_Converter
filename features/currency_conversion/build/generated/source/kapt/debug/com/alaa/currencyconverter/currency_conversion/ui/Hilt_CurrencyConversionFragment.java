...
public abstract class Hilt_CurrencyConversionFragment<DB extends ViewDataBinding> extends BaseFragment<DB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CurrencyConversionFragment_GeneratedInjector) this.generatedComponent()).injectCurrencyConversionFragment(UnsafeCasts.<CurrencyConversionFragment>unsafeCast(this));
    }
  }
